...
const ProgressRadialAllCircles = () => {
  const option = {
    textStyle: {
    ...
    title: [
      {
        text: 'Collective Progress (%), All Circles And KPIs Included',
    ...
    legend: {
      show: true,
      top: 30, // Adjust this value based on the actual height of your title
      type: 'scroll',
      padding: [5, 10],
...
export default ProgressRadialAllCircles;
